...
print(f"The average of the loans is " , average_loan)
...
if fair_value >= loan.get("loan_price"):
    print(f"This loan is worthwhile")
else:
...
loan_present_value= calculate_pv(new_loan["future_value"],new_loan["remaining_months"] , annual_discount_rate)
